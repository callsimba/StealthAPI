...
typedef struct _PEB
{
    ...
    PVOID IFEOKey;
    union _CROSSPROCESS_UNION {
        ULONG CrossProcessFlags;
        struct _CROSSPROCESS_STRUCT {
    ...
    union _CONTEXT_UNION {
        PVOID pContextData;
        PVOID pUnused;
        PVOID EcCodeBitMap;
    } ContextUnion;
    PVOID pImageHeaderHash;
    union _TRACING_UNION {
        ULONG TracingFlags;
        struct _TRACING_STRUCT {
    ...
    union _LEAPSECOND_UNION {
        ULONG LeapSecondFlags;
        struct _LEAPSECOND_STRUCT {
